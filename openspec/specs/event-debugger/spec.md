...
Defines requirements for the EventDebugger development tool. Provides a floating UI panel in DEV mode that captures and displays all published events, supporting search, filter, and JSON inspection.
