...
Defines requirements for the Activity and Stats tracking system in the API. Every member CRUD operation is recorded as an Activity entity, and a singleton Stats record is kept in sync — all within the same database transaction.
