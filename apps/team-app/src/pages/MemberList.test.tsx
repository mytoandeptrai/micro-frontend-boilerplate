...
const mockMembers = [
  { id: "1", name: "Alice", email: "alice@ops.dev", role: "admin", status: "active", avatar: null, createdAt: "2024-01-01T00:00:00.000Z", updatedAt: "2024-01-01T00:00:00.000Z" },
  { id: "2", name: "Bob", email: "bob@ops.dev", role: "member", status: "inactive", avatar: null, createdAt: "2024-01-02T00:00:00.000Z", updatedAt: "2024-01-02T00:00:00.000Z" },
];
...
describe("MemberList", () => {
  beforeEach(() => {
    (useMembers.useMembers as jest.Mock).mockReturnValue({
      data: { data: mockMembers, meta: { page: 1, limit: 10, total: 2, totalPages: 1 } },
      isLoading: false,
    });
  });
  ...
  it("renders loading state", () => {
    (useMembers.useMembers as jest.Mock).mockReturnValue({ data: undefined, isLoading: true });
    renderMemberList();
