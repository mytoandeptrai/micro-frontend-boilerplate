...
export declare function useQueryState(key: string, parser?: {
    defaultValue?: unknown;
}): readonly [any, (v: any) => void];
export declare function useQueryStates(parsers: Record<string, {
    defaultValue?: unknown;
}>): readonly [Record<string, any>, (partial: Record<string, any>) => void];
export declare function NuqsAdapter({ children }: {
